...
### Added
- **Simplified Chinese README** (`README.zh-CN.md`): Full translation for the Chinese developer community.
- **Japanese README** (`README.ja.md`): Full translation for the Japanese developer community.
- **4-language selector**: All READMEs now include navigation links to EN / 繁體中文 / 简体中文 / 日本語.
